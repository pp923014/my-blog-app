...
const MainSection = () => {
  ...
  return (
    <section className="py-20 bg-purple-500 min-h-[80vh] flex flex-col-reverse md:flex-row justify-between gap-5 items-center px-10" style={{backgroundColor:"rgba(7,214,255,1"}}>
      {/* INFORMATION DIV */}
